    ...
    <div className="min-h-screen bg-[#f9fafb] flex items-center justify-center p-8 selection:bg-indigo-100 selection:text-indigo-900 font-sans relative overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-12">
          ...
          <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Suler EMS</h1>
        ...
        <div className="bg-white rounded-[40px] p-12 shadow-[0_32px_64px_-12px_rgba(0,0,0,0.08)] border border-slate-100 relative overflow-hidden">
          <div className="mb-10 text-center">
            <h2 className="text-xl font-extrabold text-slate-900 mb-2">Secure Access</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-indigo-600 hover:bg-indigo-700 disabled:bg-slate-100 disabled:text-slate-400 text-white font-extrabold text-[13px] uppercase tracking-[0.1em] py-5 rounded-2xl transition-all duration-300 shadow-xl shadow-indigo-100 active:scale-[0.98] flex items-center justify-center gap-3 group relative"
            >
              {isLoading ? (
          ...
          <div className="mt-12 pt-10 border-t border-slate-50">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-4 bg-slate-50/50 rounded-2xl border border-slate-100/50">
                ...
                <code className="text-xs text-indigo-600 font-extrabold">chinedu.okoro@suler.ems</code>
              </div>
              <div className="flex items-center justify-between p-4 bg-slate-50/50 rounded-2xl border border-slate-100/50">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">Secret</span>
                <code className="text-xs text-indigo-600 font-extrabold">password123</code>
              </div>
            </div>
          </div>
        </div>
