...
export const OrganizationProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const syncState = (nextHubs: Hub[], nextDepts: Department[]) => {
  ...
  const addHub = (data: Omit<Hub, 'id' | 'status' | 'departments' | 'staff' | '_v'>) => {
    const newHub: Hub = {
      ...data,
  ...
  const addDepartment = (data: Omit<Department, 'id' | 'staff' | '_v'>) => {
