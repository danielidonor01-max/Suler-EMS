...
const Sidebar: React.FC<SidebarProps> = ({ isCollapsed, onToggle }) => {
  ...
  const personalModules = [
    ...
    { name: 'Peer Feedback', icon: MessageSquare, href: '/performance/feedback' },
  ...
  const governanceModules = [
    ...
    { name: 'Review Cycles', icon: Award, href: '/performance/cycles', permission: Permissions.WORKFORCE_EDIT },
