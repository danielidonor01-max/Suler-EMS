...
export const CreateHubModal: React.FC<CreateHubModalProps> = ({ isOpen, onClose }) => {
...
export const CreateDeptModal: React.FC<CreateDeptModalProps> = ({ isOpen, onClose, parentHub }) => {
  const [name, setName] = useState('');
